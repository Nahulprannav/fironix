...
const WORKSHOPS = [
    {
        ...
        description: "An incredibly fast-paced hybrid workshop dissecting the deeply internal mechanics of handling complex asynchronous state. We will refactor a huge production application entirely in real-time.",
        date: "April 12, 2026",
    ...
    },
    {
        ...
        description: "Executing complex red-team operations against entirely simulated enterprise networks. You will learn Nmap scripting, Metasploit payloads, and lateral movement in Active Directory.",
        date: "April 18, 2026",
    ...
    },
    {
        ...
        description: "Stop waiting for builds. In this workshop, you will architect ultra-lightweight alpine containers, establish multi-stage caching, and deploy entirely to Kubernetes clusters.",
        date: "April 25, 2026",
    ...
    },
    {
        ...
        description: "Bridging the immense gap between UI/UX layout and actual React physics. We will take high-end Figma mockups and execute them flawlessly using completely accurate Framer Motion spring physics.",
        date: "May 02, 2026",
        ...
        <div className="min-h-screen bg-background relative overflow-hidden flex flex-col pt-24">
            ...
            <main className="flex-1 container mx-auto max-w-5xl px-4 py-12 relative z-10">
                <motion.div
                    ...
                    className="section-shell p-10 md:p-14 text-center mb-16 relative overflow-hidden"
                >
                    ...
                    <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
                        Intensive, mentor-led deep dives into highly specialized engineering paradigms. Limited seating available.
                    </p>
                </motion.div>
                    ...
                    {WORKSHOPS.map((workshop, idx) => (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                <span className={`inline-block px-3 py-1 text-xs font-bold rounded-full mb-4 border ${workshop.colorClass}`}>
                                    {workshop.type} Level
                                </span>

                                <h2 className="font-display text-2xl font-bold mb-3 text-foreground group-hover:text-glow transition-all">
                                    {workshop.title}
                                </h2>
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm font-medium text-foreground/80">
                                    <div className="flex justify-start items-center gap-2">
                                        <Calendar size={16} className="text-primary shrink-0" /> {workshop.date}
                                    </div>
                                    <div className="flex justify-start items-center gap-2">
                                        <Clock size={16} className="text-primary shrink-0" /> {workshop.time}
                                    </div>
                                    <div className="flex justify-start items-center gap-2">
                                        <MapPin size={16} className="text-primary shrink-0" /> {workshop.location}
                                    </div>
                                    <div className="flex justify-start items-center gap-2">
                                        <Users size={16} className="text-primary shrink-0" /> {workshop.seats} Seats Limit
                                    </div>
                                </div>
                            </div>

                            <div className="w-full md:w-auto flex flex-col md:items-end justify-center shrink-0 border-t md:border-t-0 md:border-l border-border/50 pt-6 md:pt-0 md:pl-8 mt-4 md:mt-0 h-full">
